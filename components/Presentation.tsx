            ...
            <ResponsiveContainer width="100%" height={300}>
                <LineChart data={chartData} margin={{ top: 5, right: 20, left: 25, bottom: 25 }}>
                    ...
                    <YAxis 
                        ...
                        label={{ value: 'Lucro (R$)', angle: -90, position: 'insideLeft', offset: -35 }} 
                    />
                    <Tooltip 
    ...
    return (
        <div className="presentation-wrapper">
            ...
            <button onClick={() => setIsNinaOpen(true)} className="nina-fab" title="Converse com a Nina AI">
                <img src="https://labirintar.github.io/governanca/pitchDeck/image/IMG_1229.png" alt="Nina AI Avatar" className="w-full h-full object-contain p-2" />
            </button>
